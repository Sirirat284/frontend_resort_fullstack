    ...
    const formatDate = (date: Date | string) => {
      ...
      const checkAvailability = async () => {
        ...
        try {
            ...
            url.searchParams.append('roomTypeID', "3");
        ...
        <div className={styles.contentWrapper}>
            <div className={styles.roomTypeContainer}>
                <div className={styles.details}>
                    <h2>บ้านพัก สำหรับ 1 ครอบครัว</h2>
                    <h3>รายละเอียด</h3>
                    ...
                    <p className={styles.price}>ราคา: <span className={styles.priceNum}>1500</span> บาท/คืน</p>
                ...
                <div className={styles.imageContainer}>
                    <img src="DALL·E 2024-03-19 01.34.36 - A family-friendly resort bedroom within the picturesque resort setting, blending traditional and modern elements to accommodate a family. The room sho.webp" alt="ห้องพัก" />
                </div>
            </div>
        </div>
        <Footer />
